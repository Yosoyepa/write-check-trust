...
| Documento | Contenido |
|---|---|
| [Estado (léelo primero)](STATUS.md) | Qué existe, qué falta y los comandos para verificarlo por tu cuenta — si un comando y un documento discrepan, gana el comando. |
...
| [Dossier de evolución](evolution/README.md) | Auditoría de gates, estudio de DeepSeek Harness y programa propuesto para medir modelos económicos. |
