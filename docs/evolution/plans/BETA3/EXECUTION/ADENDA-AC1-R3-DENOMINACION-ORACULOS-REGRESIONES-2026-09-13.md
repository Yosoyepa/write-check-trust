...
| `test_transport_captures_descendant_output_after_leader_exit` | `process.x__observe__mutmut_31` | la salida del descendiente del grupo se captura tras la salida del líder |
