...
| E4 | **GS-2**: `semgrep_scope.py` | **EJECUTADO y en cierre de adjudicación**: bruto **102 killed + 16 survived** (base `ee1e878`); causal inicial 63 evidenciados + 16 confirmados + 39 pendientes; addenda `ADENDA-GS2-ATRIBUCION-ADJUDICACION-2026-09-14.md`: 4 pendientes atribuidos, los 16 supervivientes adjudicados como propuesta clase A (GAP-DE-ORÁCULO, sin ratificar) y 35 siguen pendientes por presupuesto. Lote **FAIL-survivors-stop** hasta el incremento de reparación | Decidir el oráculo de prefijo para los 8 mensajes y las regresiones de validación tipada; atribuir los 35 restantes |
